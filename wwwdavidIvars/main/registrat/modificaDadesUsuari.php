<?php
    ...
    $sql_nom1="SELECT * FROM hosting_davidIvars WHERE correu = '$correu_modifica'"; 
...
<body>
  ...
  <li class="list"><a href="https://2daw10.ticsimarro.org/wwwdavidIvars/main/registrarse/registre.php">Registrarse</a></li>
    ...
    <h1>Benvingut/a <?php echo $correu1 ?> <a href="desconnecta.php" style="color: red;"> Desconnectat.</a> </h1>

    <h1>Les teues dades: </h1>

    <div class="div_formulario">
    <form action="processaModificaDadesUsuari.php" method="post" class="formulario">
        ...
        <div style="display: flex; ">
            ...
            <fieldset>
                <input type="text" id="lname" name="cognom" value="<?php echo $cognom1 ?>"><br><br>
            </fieldset>
        </div>
        ...
        <div style="display: flex; ">
            ...
            <fieldset>
                <input type="email" disabled="disabled" id="lname" name="email" value="<?php echo $correu1 ?>" readonly> <span style="color: red;"> ::No es pot modificar</span> <br>
            </fieldset>
        </div>
        ...
        <div style="display: flex; ">
            ...
            <fieldset>
                ...
                if ($imatge_gran == "gran"){ 
                    ...
                    <span style="font-family: monospace; color: red">Imatge molt gran.</span> 
    ...
    <h2> <a href="dadesUsuari.php?correu1=<?php echo $correu_modifica ?>">Cancelar Modificacio</a> </h2> <br>
